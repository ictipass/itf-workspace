...
const AUDIT_COLORS: Record<AuditAction, "default" | "secondary" | "destructive" | "outline"> = {
  ...
  MFA_RECOVERY_CODES_REGENERATED: "secondary",
  MFA_REPLACEMENT_STARTED: "secondary",
  MFA_REPLACED: "destructive",
  MFA_RECOVERY_AUTHORITY_GRANTED: "default",
  MFA_RECOVERY_AUTHORITY_REVOKED: "destructive",
  MFA_RECOVERY_REQUEST_CREATED: "secondary",
  MFA_RECOVERY_REQUEST_APPROVED: "default",
  MFA_RECOVERY_REQUEST_REJECTED: "destructive",
  MFA_RECOVERY_COMPLETED: "destructive",
  SECURITY_NOTIFICATION_SENT: "secondary",
  SECURITY_NOTIFICATION_FAILED: "destructive",
