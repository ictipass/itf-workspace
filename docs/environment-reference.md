...
| `WORKSPACE_MFA_RECOVERY_MAX_ATTEMPTS` | No | 5 | 3–10 invalid password/recovery-code attempts |
| `WORKSPACE_MFA_RECOVERY_LOCK_MINUTES` | No | 30 | 5–1440 minutes |

Recovery codes are generated by Workspace with 96 bits of cryptographic randomness, displayed once and stored only
as user-bound SHA-256 hashes. Operators do not generate or configure recovery codes in environment variables.
