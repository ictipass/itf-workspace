...
| W08 | Workspace security regression test foundation | Implemented | 90 Workspace regressions across 17 suites additionally cover application administration and the protected in-product support centre; every production build verifies both organization-workbook function traces contain the complete dynamically loaded Excel dependency graph. See [`slices/W08-security-regression-foundation.md`](slices/W08-security-regression-foundation.md) |
