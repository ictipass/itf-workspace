...
| W03 | Workspace launch v2 issuer aligned with ITF Flow | Implemented | Workspace `9cbec46`, `42c4f3b`, onboarding correction `4c88f89`; ITF Flow `f0696bc`; RS256/JWKS, assurance/TOTP, single-use receiver and contract tests. See [`slices/W03-workspace-launch-v2.md`](slices/W03-workspace-launch-v2.md) |
...
| W08 | Workspace security regression test foundation | Implemented | `444287a`, expanded through `4c88f89`; 32 Workspace tests across eight suites plus 8 ITF Flow security tests cover authoritative users, configuration, first-login ordering, session policy, launch v2, assurance/TOTP and launch URLs. See [`slices/W08-security-regression-foundation.md`](slices/W08-security-regression-foundation.md) |
