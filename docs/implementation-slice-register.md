...
| W08 | Workspace security regression test foundation | Implemented | 78 Workspace regressions across 15 suites now additionally cover organization bulk-import contracts, configurable bounds, mandatory receipt/fresh-MFA/transaction controls, and receipt binding, tamper and expiry behavior. See [`slices/W08-security-regression-foundation.md`](slices/W08-security-regression-foundation.md) |
